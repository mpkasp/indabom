...
urlpatterns = [
    ...
    url(r'^(?P<part_id>[0-9]+)/part-match/$', views.octopart_part_match, name='octopart-part-match'),
    url(r'^(?P<part_id>[0-9]+)/part-match-indented/$', views.octopart_part_match_indented, name='octopart-part-match-indented'),
    ...
    url(r'^(?P<part_id>[0-9]+)/delete-file/(?P<partfile_id>[0-9]+)/$', views.delete_file_from_part, name='delete-file-from-part'),
